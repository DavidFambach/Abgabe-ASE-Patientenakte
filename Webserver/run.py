...
if __name__ == "__main__":
    ...
    _read_all(subprocess.Popen(["python", "-m", "waitress", "--listen=*:8000", "AuthService.wsgi:application"], stdout=subprocess.PIPE, stdin=subprocess.PIPE, stderr=subprocess.STDOUT))
